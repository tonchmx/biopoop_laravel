...
<h3>Han recibido un mensaje de uno de sus clientes, ahorita le describimos todo el mensaje.</h3>
...
El o ella les comenta lo siguiente:
    ...
    <tbody class="mcnTextBlockOuter">
        <tr>
            <td valign="top" class="mcnTextBlockInner">
                <div class="mcnTextContent" style="margin:1em;"><blockquote style="border: 1px solid #F2F2F2; padding: 1em;">
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" width="600" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:9px; padding-right: 18px; padding-bottom: 9px; padding-left: 18px;">
                            ...
                            Les recomendamos ponerse en contacto con el o ella para que sigan cono ese excelente servicio que los distingue de todas las otras empresas.<br>
<br>
Cualquier duda o problema con el servicio de su sitio web en general, no duden en contactarnos.<br>
&nbsp;
<div style="text-align: right;">Atte: On My Mind Crew</div>
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" width="600" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:9px; padding-right: 18px; padding-bottom: 9px; padding-left: 18px;">
                            ...
                            <div style="text-align: center;"><em>On My Mind<br>
Chetumal, Quintana Roo, México<br>
<a href="http://www.onmymind.mx" target="_blank">http://www.onmymind.mx</a></em></div>
